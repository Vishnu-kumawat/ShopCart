...
const Login = ({ openSignUp }) => {
    return (
        <div className="max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl mx-auto p-4 sm:p-6 bg-white rounded-lg shadow-md">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-4">Login</h2>
            <form>
                <div className="mb-4">
                    <label className="block text-sm sm:text-base text-gray-700" htmlFor="email">Email</label>
                    <input
                        className="w-full px-3 py-2 border border-gray-300 rounded"
                        type="email"
                        placeholder="Enter Email"
                ...
                <div className="mb-4 flex items-center justify-between">
                    <label className="inline-flex items-center" htmlFor="remember">
                        <input className="form-checkbox" type="checkbox" id="remember" />
                        <span className="ml-2 mr-4 text-sm sm:text-base text-gray-700">Remember me</span>
                    </label>
                    <a className="text-sm sm:text-base text-red-800" href="#">Forgot Password?</a>
                </div>
            ...
            <div className="flex justify-between">
                ...
                <button className="text-sm sm:text-base text-red-800" onClick={openSignUp}>Sign Up</button>
            </div>
        </div>
    );
};
