...
const WeeklyProducts = () => {
    ...
    return (
        <div>
            {/* <div className='mx-16'>
                <p className='text-2xl font-semibold mt-5'>Weekly Popular Products</p>
                ...
                {products.slice(3,6).map((product) => (
                    <div key={product.id} className="shadow-2xl border-gray-600 rounded-3xl mt-2 flex justify-center flex-col items-center pb-2">
                        ...
                        <div className='flex mt-5'>
                            <p className='mr-1 ml-2 text-lg'>Price : ${product.price.toFixed(2)} </p>
                            ...
                            <span className='line-through px-1 text-gray-500 font-semibold text-lg'>${(product.price * 2).toFixed(2)}</span>
                        </div>
            ...
            {/* <div className='mx-4 sm:mx-8 md:mx-16 lg:mx-20 xl:mx-20'>
